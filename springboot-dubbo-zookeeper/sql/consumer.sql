...
--
-- Host: 127.0.0.1    Database: consumer
-- ------------------------------------------------------
...
DROP TABLE IF EXISTS `consumer_table`;
...
-- Dump completed on 2020-12-19 23:13:46
